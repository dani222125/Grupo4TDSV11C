                        ...
                        <form method="POST" action="{{ route('pedidos.update', $pedido->id) }}">
                            ...
                            <div class="form-group row">
                                <label for="cliente_id"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Cliente') }}</label>

                                <div class="col-md-6">
                                    <select id="id_cliente" class="form-control @error('id_cliente') is-invalid @enderror"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="observaciones" class="form-control @error('observaciones') is-invalid @enderror" name="observaciones"
                                        required>{{ old('observaciones', $pedido->observaciones) }}</textarea>
                            ...
                            <div class="form-group row">
                                <label for="fecha_pedido"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Fecha Pedido') }}</label>

                                <div class="col-md-6">
                                    <input type="date" id="fecha_pedido"
                                        class="form-control @error('fecha_pedido') is-invalid @enderror" name="fecha_pedido"
                                        required value="{{ old('fecha_pedido', $pedido->fecha_pedido) }}">
                            ...
                            <div class="form-group row">
                                <label for="fecha_entrega"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Fecha entrega') }}</label>
